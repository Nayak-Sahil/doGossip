      ...
      <div className="relative flex max-w-screen-xl flex-col overflow-hidden px-4 py-4 md:mx-auto md:flex-row md:items-center">
        ...
        >
          <ul className="w-max justify-between flex flex-col items-center space-y-2 md:ml-auto md:flex-row md:space-y-0">
            <ListItem NavLink="https://github.com/Nayak-Sahil" children="Github" icon={faGithub} />
            <ListItem NavLink="https://www.linkedin.com/in/sahil-nayak/" children="LinkedIn" icon={faLinkedinIn} />
          </ul>
        </nav>
      </div>
    </header>
